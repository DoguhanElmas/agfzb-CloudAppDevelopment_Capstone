...
def analyze_review_sentiments(text):
    api_key = "6B4YAkDv16ZQlHq6vPRdxMUvCbDAkXVNneHkDeHvEg0X"
    url = "https://api.eu-gb.natural-language-understanding.watson.cloud.ibm.com/instances/495761f3-bc83-4c9a-8d33-000356a5c98a"
    texttoanalyze= text
    version = '2020-08-01'
